...
// Copyright (c) 2014 The Tritium developers
...
uint256 hashGenesisBlock("0x0000088ff61e4ae51c5778739791ed4d48f4edca2167bde6d4adcd6d35c71ef4");
...
const string strMessageMagic = "Tritium Signed Message:\n";
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "7 October 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
//bnnn
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x37f0a8cf5ec949b577aa69059a964555c867d417d4f5c1c44023f90d27392729"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TritiumMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TritiumMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TritiumMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Tritium-miner");
    ...
    try { loop {
        ...
        printf("Running TritiumMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("TritiumMiner terminated\n");
        throw;
    }
}
